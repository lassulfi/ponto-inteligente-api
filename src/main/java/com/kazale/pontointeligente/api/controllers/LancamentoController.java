...
public class LancamentoController {
	...
	/**
	 * Retona uma listagem de lancamentos por funcionario
	 * 
	 * @param funcionarioId
	 * @param pag
	 * @param ord
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		log.info("Buscando lancamentos por ID para o funcionario {}, página {}", funcionarioId, pag);
	...
	public ResponseEntity<Response<LancamentoDto>> adicionar(@Valid @RequestBody LancamentoDto lancamentoDto,
		...
		log.info("Adicionando lacamento {}", lancamentoDto.toString());
		Response<LancamentoDto> response = new Response<>();
	...
	/**
	 * Autaliza os dados de lancamento
	 * 
	 * @param id
	 * @param lancamentoDto
	 * @param result
	...
	private void validarFuncionario(LancamentoDto lancamentoDto, BindingResult result) {
		if (lancamentoDto.getFuncionarioId() == null) {
			result.addError(new ObjectError("funcionario", "Funcionairo não informado"));
			return;
		}

		log.info("Validando um funcionario com id {}", lancamentoDto.getFuncionarioId());
	...
	/**
	 * Converte uma entidade de lancamento para o seu respectivo DTO
	 * 
	 * @param lancamento
