...
public class CadastroPFController {
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		funcionario.getQtdeHorasAlmocoOpt().ifPresent(
				qtdeHorasAlmoco -> cadastroPFDto.setQtdeHorasAlmoco(Optional.of(Float.toString(qtdeHorasAlmoco))));
		funcionario.getQtdeHorasTrabalhoDiaOpt().ifPresent(qtdeHorasTrabalhoDia -> cadastroPFDto
