...
public class CadastroPJController {
	...
	/**
	 * Realiza o cadastro de uma pessoa jurídica
	 * 
	 * @param cadastroPJDto
	 * @param result
	 * @return
	...
	public ResponseEntity<Response<CadastroPJDto>> cadastrar(@Valid @RequestBody CadastroPJDto cadastroPJDto,
		...
		if (result.hasErrors()) {
			log.error("Erro ao validar dados de cadastro de PJ: {}", result.getAllErrors());
	...
	/**
	 * Converte os dados cadastrados no banco para DTO
	 * 
	 * @param funcionario
	...
	/**
	 * Verifica se a empresa ou funcionário já estão cadastrados
	 * 
	 * @param cadastroPJDto
	 * @param result
	 */
